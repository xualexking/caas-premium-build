      ...
      <section className="py-16">
        <div className="container-x grid lg:grid-cols-2 gap-8">
          <div className="grid sm:grid-cols-2 gap-4">
            <ContactCard icon={Phone} label="Phone" value="+1 (000) 000-0000" href="tel:+10000000000" primary />
            <ContactCard icon={MessageCircle} label="WhatsApp" value="Chat with dispatch" href="https://wa.me/10000000000" />
