...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CAAS Towing & Recovery — 24/7 Heavy Duty Towing in Ghana" },
      ...
      { name: "twitter:title", content: "CAAS Towing & Recovery — 24/7 Heavy Duty Towing" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://caastowing.com/kobby.svg",
          priceRange: "$$",
          areaServed: "GH",
