...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CAAS Towing & Recovery: 24/7 emergency towing, heavy equipment transport, vehicle recovery, flood recovery, and commercial fleet support. Fast dispatch. Professional drivers." },
      { name: "author", content: "CAAS Towing & Recovery" },
      { name: "theme-color", content: "#0B0B0B" },
      { property: "og:title", content: "CAAS Towing & Recovery — 24/7 Heavy Duty Towing" },
      { property: "og:description", content: "Fast, reliable, professional towing and heavy recovery. 24/7 emergency response." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/kobby.ico", type: "image/x-icon" },
