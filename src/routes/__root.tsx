...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "KA4nfHWCC9YqImbaynlZMs9pN0gEgCsh4-HjPSRM4c0" },
      ...
      { property: "og:url", content: "https://www.caastowing.com" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@id": "https://www.caastowing.com/#business",
          name: "CAAS Towing & Recovery",
          url: "https://www.caastowing.com",
          telephone: "+233246773279",
          email: "dispatch@caastowing.com",
          image: "https://www.caastowing.com/og-image.jpg",
          logo: "https://www.caastowing.com/caas.svg",
          priceRange: "$$",
